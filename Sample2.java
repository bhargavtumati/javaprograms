...
public class Sample2 {
    public static void main (String args[]) {
        ...
        String result = (age>=18)?"eligible to vote":"not eligible to vote";//Enter test condition here) ? "Enter message if condition is true" : "Enter message if condition is false";
